            ...
            <div>
                ...
                <div className="text-sm space-y-2">
                    ...
                    <div className="flex items-center gap-2 pt-4">
                        <input id="newsletter-email" name="email" className="border border-gray-500/30 placeholder-gray-500 focus:ring-2 ring-indigo-600 outline-none w-full max-w-64 h-9 rounded px-2" type="email" placeholder="Enter your email" />
